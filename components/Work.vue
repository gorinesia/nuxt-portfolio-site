...
export default {
  data: () => ({
    cards: [
      { title: 'Portfolio WireFrame', skill: 'Nuxt.js×firebase', src: 'https://cdn.vuetifyjs.com/images/cards/house.jpg', redirect_url: 'https://xd.adobe.com/view/3934f9fe-6b9a-498c-959c-ce85ba53c3ae-6c67/', flex: { cols: 12, sm: 6, md: 6 } },
