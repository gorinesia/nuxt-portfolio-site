        ...
        <v-timeline>
          ...
          >
            ...
            <template v-slot:opposite>
              <span :class="`title font-weight-bold ${year.color}--text`" v-text="year.year"></span>
            </template>
  ...
  data: () => ({
    ...
    years: [
      ...
      },
      {
        ...
        year: '2012~13',
        title: '世界一周',
        content: '自由を求めて世界一周一年間の旅へ。'
      },
      {
        color: 'pink',
        year: '2015~17',
        title: 'アフリカ旅',
        content: 'アフリカ大陸縦断。妻となる奈々と出会う。'
      },
      {
        color: 'amber',
        year: '2018/11/07',
        title: '結婚',
        content: '一生一緒に旅をする生涯の伴侶が出来る。'
      },
      {
        color: 'orange',
        year: '2020/05~',
        title: 'プログラミング学習',
        content: '世界中の人々の生活に貢献するため、プログラマーになることを決意。'
      }
    ]
  })
}
